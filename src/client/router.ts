...
export const router = createRouter({
	...
	routes: [
		...
		//{ path: '/@:acct/address', component: page('wallet/address'), props: route => ({ acct: route.params.acct }) },
		...
		{ path: '/my/wallet/explore/tx/:txid/:modal', component: page('wallet/explore'), props: route => ({ txid: route.params.txid, modal: route.params.modal }) },
