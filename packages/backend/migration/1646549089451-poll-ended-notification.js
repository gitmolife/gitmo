...
export class pollEndedNotification1646549089451 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."notification_type_enum" AS ENUM('follow', 'mention', 'reply', 'renote', 'quote', 'reaction', 'pollVote', 'pollEnded', 'receiveFollowRequest', 'followRequestAccepted', 'groupInvited', 'app', 'tipReceive', 'tipSent')`);
